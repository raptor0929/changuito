...
const server = new McpServer(
  { name: 'supermercado-mcp', version: '0.2.0' },
...
// Everything above this line is read-only. Everything below it can change the
// user's real cart and, behind two restated-amount gates, spend money.
