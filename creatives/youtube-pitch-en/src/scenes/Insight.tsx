...
const TABS = [
  { store: "Market A", price: 5320, x: 1120, y: 160, rot: -6, at: 130 },
  { store: "Market B", price: 4210, x: 1480, y: 280, rot: 5, at: 148 },
  { store: "Market C", price: 4650, x: 1160, y: 500, rot: 4, at: 166 },
  { store: "Market D", price: 4980, x: 1500, y: 640, rot: -4, at: 184 },
];

const NOTES = [
  { text: "The endless list.", at: 48 },
  { text: "Prices that move.", at: 128 },
  { text: "Time you don't get back.", at: 208 },
];
    ...
    <SceneShell background={COLORS.espresso} durationInFrames={duration} push={0.025}>
      <Headline
        ...
        lines={[
          "IN ARGENTINA,",
          "GROCERY SHOPPING",
          { text: "IS A SECOND JOB.", box: COLORS.arcilla, ink: COLORS.espresso },
        ]}
      />
