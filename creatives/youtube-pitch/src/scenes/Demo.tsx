...
const MESSAGE = "Leche, pan, yerba y frutas para la semana.";
const TYPE_FROM = 18;
const TYPE_TO = 78;
const SEND = 86;
const REPLY = 118;

const CHIPS = ["Leche x2", "Pan francés", "Yerba 1 kg", "Frutas", "Café"];

const STORES = [
  { name: "Súper A", price: 4980 },
  { name: "Súper B", price: 4210, best: true },
  { name: "Súper C", price: 4650 },
];

const CART = [
  { name: "Leche entera x2", price: 3780 },
  { name: "Pan francés", price: 2450 },
  { name: "Yerba 1 kg", price: 4210 },
  { name: "Frutas de estación", price: 6130 },
  { name: "Café", price: 3900 },
  { name: "Huevos x12", price: 4280 },
  { name: "Queso cremoso", price: 5960 },
  { name: "Aceite", price: 3640 },
  { name: "Fideos", price: 1890 },
  { name: "Detergente", price: 2150 },
];
  ...
  const caption =
    frame < COMPARE_IN + 8
      ? {
          ...
          title: "En natural.",
          body: "Le hablás como a alguien de casa.",
          pose: "idle" as const,
          at: 6,
        }
      : frame < CART_IN + 8
        ? {
            ...
            body: "El mismo producto. Tres súper.",
        ...
        : {
            ...
            body: "El carrito queda listo para confirmar.",
            pose: "lleno" as const,
            at: CART_IN,
          };
